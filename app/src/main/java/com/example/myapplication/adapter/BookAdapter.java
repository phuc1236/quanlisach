...
public class BookAdapter extends BaseAdapter implements Filterable {
    ...
    public ArrayList<Book> context;
    public LayoutInflater inflater;


    public BookAdapter(ArrayList context, Context arraySach) {
        super();
        this.context = context;
        this.arrSach = (List<Sach>) arraySach;
        this.arrSortSach = (List<Sach>) arraySach;
        this.inflater = (LayoutInflater)context.get(Integer.parseInt(Context.LAYOUT_INFLATER_SERVICE));
